...
describe('babel-restore-jsx', () => {
  it('should convert 1-argument calls', () => {
    ...
    expect(jsx('React.createElement(Foo.Bar)')).toMatchInlineSnapshot(`"<Foo.Bar />;"`);
    expect(jsx('React.createElement(Foo.Bar.Baz)')).toMatchInlineSnapshot(`"<Foo.Bar.Baz />;"`);
  });

  it('should convert effective 1-argument calls (with null or undefined)', () => {
    expect(jsx('React.createElement("h1", null)')).toMatchInlineSnapshot(`"<h1 />;"`);
    expect(jsx('React.createElement("h2", null, null)')).toMatchInlineSnapshot(`"<h2 />;"`);
    expect(jsx('React.createElement("h3", undefined)')).toMatchInlineSnapshot(`"<h3 />;"`);
  });
  ...
  it('should handle spread props', () => {
    expect(jsx('React.createElement("h1", props)')).toMatchInlineSnapshot(`"<h1 {...props} />;"`);
  ...
  it('should handle props and ignore “null”/“undefined” children', () => {
    expect(jsx('React.createElement("h1", {hi: there}, null, undefined)')).toMatchInlineSnapshot(
      `"<h1 hi={there} />;"`,
    );
  });

  it('should ignore “null”/“undefined” props and handle children', () => {
    expect(jsx('React.createElement("h1", null, "Header")')).toMatchInlineSnapshot(
      `"<h1>Header</h1>;"`,
    );
    //this can be created from e.g. '<h2>Header{"harhar"}</h2>', but i think there’s no downside to merging it
    expect(jsx('React.createElement("h2", null, "Header", "harhar")')).toMatchInlineSnapshot(
      `"<h2>Headerharhar</h2>;"`,
    );
  ...
  it('should handle props and children', () => {
    ...
    expect(jsx('React.createElement("h1", {hi: there}, "Header")')).toMatchInlineSnapshot(
      `"<h1 hi={there}>Header</h1>;"`,
    );
  });

  it('should ignore intermingled “null”/“undefined” children', () => {
    expect(jsx('React.createElement("h1", null, null, "Header", undefined)')).toMatchInlineSnapshot(
      `"<h1>Header</h1>;"`,
    );
  });
  ...
  it('should handle children in nested expressions', () => {
    expect(
      jsx('React.createElement("h1", null, foo ? React.createElement("p") : null)'),
    ).toMatchInlineSnapshot(`"<h1>{foo ? <p /> : null}</h1>;"`);
  });

  it('should handle lowercase component names', () => {
    expect(jsx('React.createElement(aaa)')).toMatchInlineSnapshot(`"React.createElement(aaa);"`);
  });
});
